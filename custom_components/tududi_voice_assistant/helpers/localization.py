"""Localization utilities for Tududi voice assistant responses."""
...
_BASE: Dict[str, Dict[str, str]] = {
    ...
    "config_error": {
        "en": "Configuration error. Please check your Tududi and Home Assistant AI settings.",
        "fr": "Erreur de configuration. Vérifiez les paramètres Tududi et de l'IA Home Assistant.",
        "es": "Error de configuración. Verifica la configuración de Tududi y de la IA de Home Assistant.",
        "pt": "Erro de configuração. Verifique as configurações do Tududi e da IA do Home Assistant.",
        "ru": "Ошибка конфигурации. Проверьте настройки Tududi и ИИ Home Assistant.",
        "hi": "कॉन्फ़िगरेशन त्रुटि। कृपया Tududi और Home Assistant AI सेटिंग्स जाँचें।",
        "zh-Hans": "配置错误。请检查 Tududi 和 Home Assistant AI 设置。",
        "ar": "خطأ في الإعدادات. يرجى التحقق من إعدادات Tududi وذكاء Home Assistant الاصطناعي.",
        "bn": "কনফিগারেশন ত্রুটি। Tududi এবং Home Assistant AI সেটিংস পরীক্ষা করুন।",
        "id": "Kesalahan konfigurasi. Periksa pengaturan Tududi dan AI Home Assistant.",
        "de": "Konfigurationsfehler. Bitte überprüfen Sie Ihre Tududi- und Home-Assistant-AI-Einstellungen.",
    },
    "llm_conn_error": {
    ...
    "tududi_add_error": {
        "en": "Sorry, I couldn't add the task to Tududi. Please check your Tududi connection.",
        "fr": "Impossible d'ajouter la tâche à Tududi. Vérifiez la connexion.",
        "es": "No se pudo añadir la tarea a Tududi. Verifica la conexión.",
        "pt": "Não foi possível adicionar a tarefa ao Tududi. Verifique a conexão.",
        "ru": "Не удалось добавить задачу в Tududi. Проверьте подключение.",
        "hi": "Tududi में कार्य जोड़ने में विफल। कनेक्शन जाँचें।",
        "zh-Hans": "无法将任务添加到 Tududi。请检查连接。",
        "ar": "تعذر إضافة المهمة إلى Tududi. تحقق من الاتصال.",
        "bn": "Tududi তে টাস্ক যোগ করা যায়নি। সংযোগ পরীক্ষা করুন।",
        "id": "Tidak dapat menambahkan tugas ke Tududi. Periksa koneksi.",
        "de": "Entschuldigung, ich konnte die Aufgabe nicht zu Tududi hinzufügen. Bitte überprüfen Sie Ihre Tududi-Verbindung.",
    },
    "json_parse_error": {
...
def _load_relative():  # lazy load
    ...
    try:
        base_dir = os.path.dirname(os.path.dirname(__file__))  # helpers/ -> tududi/
